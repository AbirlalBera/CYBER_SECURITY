...
After installation, a **new tab** will appear in Burp Suite. Some extensions add new tabs, while others add right-click menu options.

Although this example doesn’t explain how to use Request Timer in detail, you should explore the new tab to understand its features. It can be very helpful during web application security testing, especially for identifying timing-based issues.