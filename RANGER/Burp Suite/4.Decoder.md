...
Decoder allows us to create hashsums for data directly within Burp Suite.we click on the **Hash** dropdown menu and select an algorithm from the list:

![[Pasted image 20260112174239.png]]
