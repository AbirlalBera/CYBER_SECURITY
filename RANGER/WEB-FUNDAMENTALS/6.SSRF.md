...
Cloud metadata: Use a domain you own → DNS A record → 169.254.169.254
...
Create a malicious subdomain: https://website.thm.attacker.com  (purchase a domain that starts with same name)
...
**Trusted domain redirects requests elsewhere.**  (Method used to bypass strict rules)

```
Exploit:

Allowed URL: https://website.thm/link?url=https://attacker.com
